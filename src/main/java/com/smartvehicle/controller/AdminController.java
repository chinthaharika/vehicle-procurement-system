...
public class AdminController {
    ...
    @Autowired
    private com.smartvehicle.repository.TransferHistoryRepository transferHistoryRepository;
    ...
    public String dashboard(HttpSession session, Model model) {
        ...
        // Add Statistics
        model.addAttribute("buyerCount", userRepository.countByRoleAndStatus(User.Role.BUYER, User.Status.APPROVED));
        model.addAttribute("sellerCount", userRepository.countByRoleAndStatus(User.Role.SELLER, User.Status.APPROVED));
        model.addAttribute("soldCount", transferHistoryRepository.countByFromUserNotNull());
    ...
    public String viewTransactions(HttpSession session, Model model) {
        ...
        // Fetch all Transfer History (Transactions)
        List<com.smartvehicle.model.TransferHistory> transactions = transferHistoryRepository.findAllByOrderByTransferTimeDesc();
