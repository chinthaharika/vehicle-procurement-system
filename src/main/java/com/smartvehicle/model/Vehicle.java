...
public class Vehicle {
    ...
    @Lob
    @Column(columnDefinition = "BINARY VARYING")
    private byte[] document;

    private String documentContentType;
    private String documentFilename;

    // private String documentPath; // Removed in favor of DB storage
    ...
    public String getAccidentsHistory() {
        return accidentsHistory;
    }

    public void setAccidentsHistory(String accidentsHistory) {
